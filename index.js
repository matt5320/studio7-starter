...
dom.tasksList.addEventListener("click", (e) => {
  if (e.target.matches("input.done")) updateCounts();
...
export function clearCompleted() {
  const completed = dom.tasksList.querySelectorAll(
    "li:has(input.done:checked)"
  );
  for (const task of completed) task.querySelector("button.delete").click();
}
